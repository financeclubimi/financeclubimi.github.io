...
function makeApiCall() { //Google sheets api 
    ...
    function updateMarketPrice() { //Google sheets api 
        ...
        var params = { // The ID of the spreadsheet to retrieve data from. 
                ...
                ranges: ['Stock_Prices'],
                // TODO: Update placeholder value. // How values should be represented in the output. // The default render option is ValueRenderOption.FORMATTED_VALUE. 
...
stock_action = async function(buttonId) {
            ...
            var params = { // The ID of the spreadsheet to retrieve data from. 
                ...
                var request = gapi.client.sheets.spreadsheets.values.append(params, valueRangeBody);await request.then(async function(response) {
                        if (response.status == 200) {
